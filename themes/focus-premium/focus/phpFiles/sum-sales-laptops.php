...
INNER JOIN categories AS ca ON i.cat_ID = ca.ID WHERE ca.name = "laptops" GROUP BY ca.ID;';
...
INNER JOIN categories AS ca ON i.cat_ID = ca.ID WHERE ca.name = "laptops" GROUP BY od.item_ID;';
